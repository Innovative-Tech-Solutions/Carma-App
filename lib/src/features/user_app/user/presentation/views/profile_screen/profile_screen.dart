...
import 'package:carma_app/src/features/user_app/user/presentation/views/profile_screen/profile_screen_vm.dart';
                      ...
                      Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildInfoItem('assets/images/profileicon.png',
                                  viewModel.name),
                              const SizedBox(height: 20),
                              _buildInfoItem(
                                  'assets/images/mail.png', viewModel.email),
                              const Divider(
                                thickness: 1,
                                color: Color.fromARGB(255, 243, 148, 30),
                              ),
                              _buildInfoItem('assets/images/loca.png',
                                  'sambisa forest, Borno.'),
                              const SizedBox(height: 20),
                              _buildInfoItem('assets/images/phoneicon.png',
                                  '+247 419 360 911'),
                              const Divider(
                                thickness: 1,
                                color: Color.fromARGB(255, 243, 148, 30),
